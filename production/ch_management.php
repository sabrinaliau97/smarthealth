          ...
          <!-- top part------------------------------------------------------------------------------------- -->
            <div class="page-title">
              <div class="title_left">
                <h3>CH Management (Basic Info)</h3>
              </div>
            </div>
            ...
            <div class="row" style="display: block;">
              ...
              <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    <form action='add_comhos.php' method='GET'>
                        <button type='submit' class='btn btn-success'>Add Community Hospital</button>
                    </form>
                  ...
                  <form action='edit_comhos.php' method='POST'>
                      ...
                      <tbody>
                        ...
                        foreach ($ch_list as $ch)
                        {
                            ...
                            echo ("<tr>");
                                ...
                                echo("<td>".$ch_address_new."</td>");
                                echo("<td>".$ch_contact."</td>");
                                if ($ch_fax == 0)
                                {
                                  $ch_fax = '';
                                }
                                echo("<td>".$ch_fax."</td>");
                                echo("<td>".$ch_status_new."</td>");
                            echo("</tr>");
                        }
                        ?>
                    ...
                    <table>
                    <tr>
                        <button type='submit' class='btn btn-success' style = 'background-color: #ef8d32; border-color: #ef8d32;'>Edit Community Hospital</button>
                        <button type='submit' formaction='deletech_confirmation.php' class='btn btn-success' style = 'background-color: red; border-color: red;'>Delete Community Hospital</button>
                      </form>
