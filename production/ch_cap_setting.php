            ...
            <div class="col-md-12 col-sm-12">
              ...
              <?php
				if (isset($_SESSION['MSG']))
				{
                  ...
                  <div class="x_content">
                    <form action="ch_cap_step2.php" method="POST">
                      <span class="section">Filter</span>


                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Edit by: <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <select class="form-control" name = "editby" required="required">
                              <option value="criteria">Criteria</option>
                              <option value="comhos">Community Hospital</option>
                            </select>
                        </div>
                      </div>
