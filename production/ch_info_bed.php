					...
					<div class="left_col scroll-view" style="background-color: #0a8c6a;">
						<div class="navbar nav_title" style="border: 0; background-color: #0a8c6a;">
							<div class="newfont">
								...
								<a href="ch_info_bed.php" class="site_title"><img src='images/logo3.png' alt='' width="60">CH Referral</a>
							</div>
						</div>
...
<!-- Page Content  ---------------------------------------------------------------------------------------------------------------------------------->
	    ...
	    <form action='process_announcements.php' method='POST'>
                      ...
                      ?>
                        <label for="announcements"style="font-size: 17px ; color:red"> <b><u>Announcements for all CHs:</b></u></label><br>
                        <textarea readonly class="form-control" id= 'announcements' name="announcements" rows="5" wrap="hard" ><?php echo "$announcements";?> </textarea>
            </form>  
