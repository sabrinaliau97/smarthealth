                      ...
                      <div class="x_content">
                        <?php
                          if (isset($_GET['component']))
                          {
							...
							$compo = strtoupper(str_replace("_"," ",$component));
                          }
                        ?>
                        
                        <script>
                          function redirectback(){
                            location.replace("ch_comp.php")
                          }
                        </script>

                        <h2>Are You Sure you want to remove <b> <?php echo $compo; ?></b>?</h2>
                        <table>
                          <tr>
                            <td>
                              <form action='process_deletecomp.php' method='GET'>
                                <input type='hidden' id='component' name='component' value=<?php echo $component; ?>>
                                <button type='submit' class='btn btn-primary' style="background-color:red; border:none">Delete</button>
                              </form>
                            </td>
                            <td>
                              <button onclick="redirectback()" class='btn btn-primary'>Cancel</button>
                            </td>
                          </tr>
                        </table>
                      </div>
