            ...
            <div class="col-md-12 col-sm-12">
              ...
              <?php
                if (isset($_SESSION['MSG']))
                {
                    ...
                    <div class="x_content">
                        <button onclick="document.location=\'profile.php\'" class="btn btn-success">Back to Profile</button>
                    </div>
                    ';
                ...
                else
                {
                  ...
                  <div class="x_content">
                    <form action="process_update.php" method="POST">
                      <span class="section">Edit Profile<small> (Please enter your password to update details)</small></span>

                      <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Name<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" name="name" required="required" value="'.$name.'"/>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6 col-sm-6">
                          <input class="form-control" name="email" class="email" required="required" type="email" value='.$username.'></div>
                      </div>
