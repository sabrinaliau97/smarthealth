                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                      ...
                      <div class="x_title">
                        <h2>Delete Community Hospital</small></h2>
                        <div class="clearfix"></div>
                      </div>
                      ...
                      <div class="x_content">
                        <?php
                          ...
                          {
                            $ch_list = $_POST['table_records'];
							$_SESSION['CH_LIST'] = $ch_list;

							echo " <h2>Are You Sure you want to remove <b>";
							$ch_count = count($ch_list);
							$ch_count2 = $ch_count - 1;
							if($ch_count > 1)
							{
						  ...
						  else
						  {
							...
							echo '<div style="font-size: 25px; color: red;">Please go back to Community Hospital Management Page.</style><br><br>';
