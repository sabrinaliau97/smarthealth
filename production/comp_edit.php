          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              ...
              <?php
                ...
                {
					if(isset($_GET['component']) && isset($_GET['status2']) && isset($_GET['display_type']))
					{
						$component = $_GET['component'];
						$status2 = $_GET['status2'];
						$display_type = $_GET['display_type'];
						$old_component = $component;
						$component2 = strtoupper(str_replace("_"," ",$component));
						$importance = $_GET['importance'];

						echo '

							<div class="x_content">
								<form action="process_updatecomp.php" method="POST">
								<span class="section">Edit Component</span>

								<div class="field item form-group">
									<label class="col-form-label col-md-3 col-sm-3  label-align">Component Name<span class="required">*</span></label>
									<div class="col-md-6 col-sm-6">
										<input class="form-control" name="component" required="required" value="'.$component2.'"/>
									</div>
								</div>';

									echo "<input type='hidden' name = 'display_type' value=" . $display_type . ">";


									echo '<div class="field item form-group">
								<label class="col-form-label col-md-3 col-sm-3  label-align">Status<span class="required">*</span></label>
									<div class="col-md-6 col-sm-6">
									<select class="form-control" name = "status2" required="required">';
									if($status2 == "show")
									{
								...
								<div class="field item form-group">
								<label class="col-form-label col-md-3 col-sm-3  label-align">Edit Frequency<span class="required">*</span></label>
									<div class="col-md-6 col-sm-6">
									<select class="form-control" name = "importance" required="required">';
									if($importance == "LESS_FREQUENT")
									{
										echo '<option value="LESS_FREQUENT" selected>LESS FREQUENT</option>
											<option value="FREQUENT">FREQUENT</option>';
									}
									else
									{
										echo '<option value="FREQUENT" selected>FREQUENT</option>
								...
								<input type="hidden" id="old_component" name="old_component" value=' . $old_component . '>
								...
								<div class="form-group">
									<div class="col-md-6 offset-md-3">
										...
										<table>
										<tr>
										<button type="submit" class="btn btn-primary" style = "background-color: #ef8d32; border-color: #ef8d32;">Update</button>
