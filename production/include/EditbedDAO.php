...
class EditbedDAO {
    ...
    public function editbed($sm, $sf, $ch_name, $remarks) {
        ...
        // Step 2 - Prepare SQL
        $presql = "UPDATE ch_infomation SET bed_status_sub_male = ".$sm." , bed_status_sub_female = ".$sf.", remarks = '".$remarks."' WHERE ch_name = '".$ch_name."';";
