        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              ...
              <?php
			  	// Check if user just landed on page or has added the sub criteria
				// Sub Component can only be added under Criteria when the Component is with display type as Multiselect (Checkbox)
				// e.g. of Component: Type of Care 
				// e.g. of Criteria: Wound Care
				// e.g. of Sub Component: SNAP --> under Wound Care (Dropdown list appear when wound care is selected)
				if(isset($_POST['component']))
				{
					// User just landed on the page, display form for user to fill up
					...
					<div class="x_content">
						<form action="process_subcre.php" method="POST">
				...
				else if(isset($_SESSION['COMP']) && isset($_SESSION['MSG']))
				{
					// User added new sub component
					$msg = $_SESSION['MSG'];
                    unset($_SESSION['MSG']);
					...
					echo '
						...
						<div class="x_content">
							<table>
							<tr>
							<form action="add_subcre.php" method="POST">
								<input type="hidden" id="component_comp" name="component_comp" value=' . $component_comp . '>
								<input type="hidden" id="component_disp" name="component_disp" value=' . $component_disp . '>
								<input type="hidden" id="component" name="component" value=' . $component . '>
